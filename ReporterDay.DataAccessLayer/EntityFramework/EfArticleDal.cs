...
namespace ReporterDay.DataAccessLayer.EntityFramework
{
    public class EfArticleDal : GenericRepository<Article>, IArticleDal
    {
        ...
        {
            var values=_context.Articles.Include(x=>x.AppUser).Include(y=>y.Category).Where(z=>z.ArticleId == id).FirstOrDefault(); return values;
        }
        ...
        public List<Article> GetArticlesWithCategriesAndAppUsers()
        {
